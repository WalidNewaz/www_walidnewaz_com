...
title: "Lessons Learned & Production Readiness"
...
<div style={{ backgroundColor: 'var(--surface2)', margin: '1.25rem 0', padding: '1.5rem 1.25rem 1.5rem 2rem', borderRadius: '0.5rem' }}>
