...
description: "Python's standard library provides a wide array of modules that allows programs that use concurrency."
...
> note: `subprocess` runs external programs; it does not execute Python code directly unless you call `python`.
